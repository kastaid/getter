...
plugins_help["text"] = {
    "{pfx}getformat [text]/[reply]": "Get a replied message format.",
    "{pfx}noformat [text]/[reply]": "Clean format in replied message.",
    "{pfx}nospace [text]/[reply]": "Remove all spaces in replied message.",
    "{pfx}noemoji [text]/[reply]": "Remove all emoji in replied message.",
    "{pfx}repeat [count] [reply]": "Repeat text in replied message.",
    "{pfx}count [text]/[reply]": "Count words in text message.",
    "{pfx}upper [text]/[reply]": "Convert text to UPPERCASE.",
    "{pfx}lower [text]/[reply]": "Convert text to lowercase.",
    "{pfx}title [text]/[reply]": "Convert text to TitleCase.",
    "{pfx}capital [text]/[reply]": "Convert first word to Capital.",
    "{pfx}camel [text]/[reply]": "Convert text to camelCase.",
    "{pfx}snake [text]/[reply]": "Convert text to snake_case.",
    "{pfx}kebab [text]/[reply]": "Convert text to kebab-case.",
    "{pfx}b64encode|{pfx}b64en|{pfx}b64e [text]/[reply]": "Encode and convert text to base64 data.",
    "{pfx}b64decode|{pfx}b64de|{pfx}b64d [text]/[reply]": "Decode and convert base64 data to text.",
    "{pfx}tobin [text]/[reply]": "Encode and convert text to binary.",
    "{pfx}nobin [text]/[reply]": "Decode and convert binary to text.",
    "{pfx}morse [text]/[reply]": "Encode and convert text to morse code.",
    "{pfx}nomorse [text]/[reply]": "Decode and convert morse code to text.",
    "{pfx}roman [text]/[reply]": "Convert any number less than 4000 to roman numerals.",
    "{pfx}noroman [text]/[reply]": "Convert roman numeral to number.",
    "{pfx}type [text]/[reply]": "Edits the message and shows like someone is typing.",
    "{pfx}flip [text]/[reply]": "Flip text upside down.",
    "{pfx}small [text]/[reply]": "Make caps text smaller.",
    "{pfx}normal [text]/[reply]": "Convert stylish font to normal.",
}
